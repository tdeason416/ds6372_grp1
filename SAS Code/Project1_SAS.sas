...
* GarageCars NA or 0 is base case;
if GarageCars = 1 then GarageCars_1 = 1; else GarageCars_1 = 0;
if GarageCars = 2 then GarageCars_2 = 1; else GarageCars_2 = 0;
if GarageCars = 3 then GarageCars_3 = 1; else GarageCars_3 = 0;
if GarageCars = 4 then GarageCars_4 = 1; else GarageCars_4 = 0;
if GarageCars = 5 then GarageCars_5 = 1; else GarageCars_5 = 0;
;
Run;


** GLM Selection Model from Training Data:;
                                                                                                                                                                                                
proc glmselect data=MLSData2                                                                                                                                                                                            
seed=1 plots(stepAxis=number)=(criterionPanel ASEPlot CRITERIONPANEL) plots=all;                                                                                                                              
class ;
model LogSalePrice = GrLivArea LogGrLivArea LotFrontage LotArea LogLotArea x1stFlrSF Logx1stFlrSF BsmtUnfSF LogBsmtUnfSF BsmtFinSF1 LogBsmtFinSF1 TotalBsmtSF LogTotalBsmtSF x2ndFlrSF Logx2ndFlrSF GarageArea LogGarageArea WoodDeckSF LogWoodDeckSF OpenPorchSF LogOpenPorchSF OverallQual OverallCond YearBuilt YearRemodAdd MasVnrArea LowQualFinSF BsmtFullBath BsmtHalfBath FullBath HalfBath BedRoomAbvGr KitchenAbvGr TotRmsAbvGrd Fireplaces PoolArea EnclosedPorch ScreenPorch GarageYrBlt Miscval MoSold YrSold BsmtFinSF2
...
HouseStyle_15Fin HouseStyle_15Unf HouseStyle_25Unf HouseStyle_2Story HouseStyle_SFoyer HouseStyle_SLvl GarageCars_1 GarageCars_2 GarageCars_3 GarageCars_4 GarageCars_5 /
selection=Stepwise(choose=CV stop=CV) cvmethod=split(10) CVdetails;
Run;  

************************************************
* Proc Reg and Glm - Selection Model;
* To Obtain Statistical Information about selected
* model.  'Input all variable that will be used in
* Regression Model'
************************************************;
proc reg data=MLSData2 plots=all;
	model LogSalePrice = OverallQual LogGrLivArea YearBuilt LogLotArea OverallCond LogBsmtFinSF1 Logx1stFlrSF Logx2ndFlrSF  Neighborhood_Edwards Neighborhood_IDOTRR Neighborhood_Meadow Neighborhood_OldTown Neighborhood_Blueste Neighborhood_BrkSide Neighborhood_Mitchel Neighborhood_NAmes Neighborhood_NPkVill Neighborhood_Sawyer Neighborhood_SWISU Neighborhood_Blmngtn Neighborhood_ClearCr Neighborhood_CollgCr Neighborhood_Crawfor Neighborhood_Gilbert Neighborhood_NWAmes Neighborhood_SawyerW Neighborhood_Somerst Neighborhood_Timber Neighborhood_Veenker Neighborhood_NoRidge Neighborhood_NridgHt Neighborhood_StoneBr BldgType_Twnhs BldgType_2fmCon BldgType_Duplex BldgType_TwnHsE GarageCars_1 GarageCars_2 GarageCars_3 GarageCars_4 GarageCars_5/VIF r cli;
title 'Model Regression For Stepwise (no Catagorical)';
run;

proc glm data=MLSData2 plots=all;
class ;
model LogSalePrice = OverallQual LogGrLivArea YearBuilt LogLotArea OverallCond logx1stFlrSF LogBsmtFinSF1 Logx2ndFlrSF  Neighborhood_Edwards Neighborhood_IDOTRR Neighborhood_Meadow Neighborhood_OldTown Neighborhood_Blueste Neighborhood_BrkSide Neighborhood_Mitchel Neighborhood_NAmes Neighborhood_NPkVill Neighborhood_Sawyer Neighborhood_SWISU Neighborhood_Blmngtn Neighborhood_ClearCr Neighborhood_CollgCr Neighborhood_Crawfor Neighborhood_Gilbert Neighborhood_NWAmes Neighborhood_SawyerW Neighborhood_Somerst Neighborhood_Timber Neighborhood_Veenker Neighborhood_NoRidge Neighborhood_NridgHt Neighborhood_StoneBr BldgType_Twnhs BldgType_2fmCon BldgType_Duplex BldgType_TwnHsE GarageCars_1 GarageCars_2 GarageCars_3 GarageCars_4 GarageCars_5 / cli; 

** Matrix Scatter Plot - Information Only***;
proc sgscatter data=MLSData2;
matrix LogSalePrice LogGrLivArea YearBuilt LogLotArea LogBsmtFinSF1 Logx1stFlrSF Logx2ndFlrSF;
Run;
...
* GarageCars NA or 0 is base case;
	if GarageCars_1 = "TRUE" then GarageCars_1 = 1; else GarageCars_1 = 0; 
	if GarageCars_2 = "TRUE" then GarageCars_2 = 1; else GarageCars_2 = 0;
	if GarageCars_3 = "TRUE" then GarageCars_3 = 1; else GarageCars_3 = 0;
	if GarageCars_4 = "TRUE" then GarageCars_4 = 1; else GarageCars_4 = 0;
	if GarageCars_5 = "TRUE" then GarageCars_5 = 1; else GarageCars_5 = 0;
GarageCars_1Num = GarageCars_1*1;
GarageCars_2Num = GarageCars_2*1;
GarageCars_3Num = GarageCars_3*1;
GarageCars_4Num = GarageCars_4*1;
GarageCars_5Num = GarageCars_5*1;
Drop GarageCars_1 GarageCars_2 GarageCars_3 GarageCars_4 GarageCars_5;
rename GarageCars_1Num = GarageCars_1;
rename GarageCars_2Num = GarageCars_2;
rename GarageCars_3Num = GarageCars_3;
rename GarageCars_4Num = GarageCars_4;
rename GarageCars_5Num = GarageCars_5;
;
Run;
...
class ;
model LogSalePrice = OverallQual LogGrLivArea YearBuilt LogLotArea OverallCond LogBsmtFinSF1 Logx2ndFlrSF  Neighborhood_Edwards Neighborhood_IDOTRR Neighborhood_Meadow Neighborhood_OldTown Neighborhood_Blueste Neighborhood_BrkSide Neighborhood_Mitchel Neighborhood_NAmes Neighborhood_NPkVill Neighborhood_Sawyer Neighborhood_SWISU Neighborhood_Blmngtn Neighborhood_ClearCr Neighborhood_CollgCr Neighborhood_Crawfor Neighborhood_Gilbert Neighborhood_NWAmes Neighborhood_SawyerW Neighborhood_Somerst Neighborhood_Timber Neighborhood_Veenker Neighborhood_NoRidge Neighborhood_NridgHt Neighborhood_StoneBr BldgType_Twnhs BldgType_2fmCon BldgType_Duplex BldgType_TwnHsE GarageCars_1 GarageCars_2 GarageCars_3 GarageCars_4 GarageCars_5 / cli solution;
output out = results p = Predict;
run;


/* Creating Kaggle Submission Dataset  */
