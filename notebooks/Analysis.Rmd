...
summary(lm(saleprice~x1stflrsf*x2ndflrsf, data=sub_frame))
...
* the cross validated model gives a mse of .082515 which is pretty similar to the in-sample error of .032613, so we are happy with it
...
head(pred.df)
write.csv(pred.df, '../data/r_ridge_all_vars2.csv', row.names = FALSE)
```
