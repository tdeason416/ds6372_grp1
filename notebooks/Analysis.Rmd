...
ems to explain the variance in the model fairly well, but since we used 24 columnd on 1460 data points, we may have overfit the current dataset.
...
#Observing the model with 1390 degrees of freedom, we have an adjusted R squared of .8743, so this model seems to explain much of the variance
